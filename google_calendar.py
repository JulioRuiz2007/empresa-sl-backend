...
class GoogleCalendarService:
    ...
    def _init_service(self):
        ...
        Prioriza la variable de entorno GOOGLE_CREDENTIALS_JSON (para Railway/producción).
        Si no existe, intenta leer el archivo local (para desarrollo local).
        """
        try:
            ...
            if credentials_json:
                ...
                logger.warning(
                    "⚠️  No se encontraron credenciales de Google Calendar. "
                    "Las citas se guardarán solo en la BD local."
                )
                return
